...
ARGUMENTS: index
DOES IT CHANGE ORIGINAL VALIUE: does not modify the original value
...
charAt() method
TASK: gets a single character from the string using an index - NOTE: it works backward as well as negative indexes
RETURN: returns the single character as a string
    NOTE: it returns empty string ('') if the given index is not valid for the string
ARGUMENTS: index
DOES IT CHANGE ORIGINAL VALIUE: does not modify the original value
