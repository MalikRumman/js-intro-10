...
let addresLower = address.toLowerCase();
let addresUpper = address.toUpperCase();

console.log(addresLower); // 123 st. #2 des plaines il 12345
console.log(addresUpper); // 123 ST. #2 DES PLAINES IL 12345
