...
function tripleWorld(string) {
    return string.repeat(3);
    }

console.log(tripleWorld("Tech")); // "TechTechTech"
console.log(tripleWorld("Global")); // "GlobalGlobalGlobal"
...
console.log(celciusToFahrenheit(25)); // 77
console.log(celciusToFahrenheit(0)); // 32
console.log(celciusToFahrenheit(-10)); // 14
