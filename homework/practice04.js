...
let t2ASCII = t2character.charCodeAt(0); // 97-122
...
if ((t5ASCII >= 65 && t5ASCII <= 90) || (t5ASCII >= 97 && t5ASCII <= 122)) {
    if (t5character === 'a' || t5character === 'e' || t5character === 'i' || t5character === 'o' || t5character === 'u' || t5character === 'A' || t5character === 'E' || t5character === 'I' || t5character === 'O' || t5character === 'U') {
