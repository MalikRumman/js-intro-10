...
// toFixed() vc tpPrecision()
console.log((123.23).toFixed(1)); // 123.2
console.log((123.23).toPrecision(3)); // 1
...
console.log(Number.MIN_SAFE_INTEGER); // -09007199254740991
...
console.log(Number.isSafeInteger(900719925474099194358)); // false