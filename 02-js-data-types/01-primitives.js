...
console.log(typeof name); // 'Stting'
...
//biint
let n1 = 4389579304879430875n;
let n2 = BigInt('4389579304879430875');
...
let safeMaxInt = 9007199254740991n; // it is recommended to go bigint
let safeMinInt = -9007199254740991n; // it is recommended to go bigint
